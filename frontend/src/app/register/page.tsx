...
const ROLES = [
  { role: 'enfant', label: 'Student', description: 'Child Explorer', icon: 'child_care' },
  { role: 'parent', label: 'Parent', description: 'Caregiver', icon: 'family_restroom' },
  { role: 'enseignant', label: 'Teacher', description: 'Educator', icon: 'school' },
  { role: 'psychiatre', label: 'Psychiatrist', description: 'Specialist', icon: 'psychology' },
];

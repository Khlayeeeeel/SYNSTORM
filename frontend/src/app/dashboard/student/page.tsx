...
export default function KidDashboard() {
  ...
  const { data: dashboardData, isLoading } = useDashboardData('student', 'current_user_id');
        ...
        <nav className="flex justify-between items-center w-full px-6 py-3 max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-sky-200 ml-2 shadow-sm">

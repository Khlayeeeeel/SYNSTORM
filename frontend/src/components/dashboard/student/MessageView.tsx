    ...
    >
      <header className="flex justify-between items-center">
        <div className="space-y-2">
          ...
          <p className="text-on-surface-variant opacity-70">Encouragement from your care team.</p>
        </div>
        <button className="bg-sky-100 text-sky-700 px-6 py-3 rounded-2xl font-bold text-sm hover:bg-sky-200 transition-colors flex items-center gap-2">

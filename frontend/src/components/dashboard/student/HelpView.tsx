      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-primary-container text-on-primary-container p-10 rounded-[2.5rem] shadow-xl relative overflow-hidden">
             ...
             <button className="w-full bg-white text-primary py-4 rounded-xl font-bold text-sm shadow-lg hover:shadow-white/20 active:scale-95 transition-all flex items-center justify-center gap-3">

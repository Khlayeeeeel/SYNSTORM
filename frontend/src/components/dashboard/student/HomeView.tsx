...
export const HomeView: React.FC<HomeViewProps> = ({ mockQuests, data }) => {
  return (
    <motion.div
    ...
    >
      ...
      <section className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-16 items-center">
        ...
        <div className="lg:col-span-2 relative">
          <div className="aspect-square bg-sky-100 rounded-[3rem] overflow-hidden rotate-3 hover:rotate-0 transition-transform duration-500 shadow-xl border-4 border-white">
            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBQV-VXeEOiGPQsakdMGxTgwVabU0xBL4tp6vFRuQp6Zbn9c_eOWzCcDZvLT5W0a-u9BE_QZI2wWcEIerudMOicrlXmZKnd9XqIrjWhsvs-08dMkiuhEbRpsxZK-nDGtI3TxtojXV68Pwsr9-1EnImbqe40eHVVo7CQoxD974ZZd3bSJus8EqK0ZoREjHrGi8C2t5fIS-ehfA30Jyrzsi2ceH61js4ZPe49i981KQQcPpHkfp6MUWUvh7TC4q0wAbe4FT_EneE-8u7b" alt="Hero Illustration" className="w-full h-full object-cover" />
          </div>

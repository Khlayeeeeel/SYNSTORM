  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 hidden md:flex flex-col bg-slate-100 border-r border-slate-200 z-40 p-4 gap-4">
      <div className="flex items-center gap-3 px-2 mb-6">
        <div className="w-10 h-10 rounded-xl bg-primary-container flex items-center justify-center text-on-primary-container overflow-hidden">
          <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAWlQu3gwTRjn8-4aTQc2hnnNjpNiDSsA_nVH6ZX-Qih3nVWb3YyZb3RvpN3M-SP20jDbatqYoyqAwyBnJHEtq2J8l_HT7hnFWUM3hHNuf37VxzbmJqikfK2vJx1UFfD31EWVgemsqTs48xmK6qQpLSnuvj-M2SluWqm4lhqFpvwB36XWGYQKhdCwYItUlAp6_TJe8rqdqW7VAuP-JKnfPFTuQz8Xd8TIsTV0EwkrhlpGnrs0hbDab8HNHWn34yWitPSGiUXkOWh9MA" alt="School Logo" className="w-6 h-6 object-cover" />
        </div>
        <div>
